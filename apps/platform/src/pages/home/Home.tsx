      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-white via-gray-50/30 to-white min-h-screen">
        ...
        <div className="relative container mx-auto px-6 py-20 flex flex-col items-center justify-center min-h-screen text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto mb-12 font-light leading-relaxed">
            Transform your restaurant experience with beautiful, instant digital
            menus.
            <span className="block mt-2 text-lg text-gray-500">
              No apps. No delays. Just simplicity.
            </span>
          </p>
            ...
            {[
              {
                ...
                description:
                  "Upload photos or build your menu from scratch. Ready in minutes, not hours.",
                icon: "⚡",
              },
              {
                title: "Instant access",
                description:
                  "Customers scan QR codes to view menus instantly. No downloads required.",
                icon: "📱",
              },
              {
                title: "Live updates",
                description:
                  "Change prices, add items, update availability in real-time.",
                icon: "🔄",
              },
            ].map((feature, index) => (
              ...
              {[
                {
                  number: "01",
                  title: "Create",
                  desc: "Upload menu photos or build from scratch",
                },
                {
                  number: "02",
                  title: "Customize",
                  desc: "Choose colors, layout, and styling",
                },
                {
                  number: "03",
                  title: "Share",
                  desc: "Generate QR code and go live instantly",
                },
              ].map((step, index) => (
      ...
      <div className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Join thousands of restaurants already using Qrunchy to enhance their
            customer experience.
          </p>
          <Button
            onClick={() => {
